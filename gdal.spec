...
Version  : 3.3.0
Release  : 301
URL      : https://download.osgeo.org/gdal/CURRENT/gdal-3.3.0.tar.xz
Source0  : https://download.osgeo.org/gdal/CURRENT/gdal-3.3.0.tar.xz
...
%prep
%setup -q -n gdal-3.3.0
cd %{_builddir}/gdal-3.3.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622346986
...
/usr/lib64/haswell/libgdal.so.29.0.0
/usr/lib64/libgdal.so.29
/usr/lib64/libgdal.so.29.0.0
